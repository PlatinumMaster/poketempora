...
; Tempora
	const EVENT_TEMPORA_GRUNT1_DEFEATED
	const EVENT_TEMPORA_GRUNT2_DEFEATED
	const EVENT_TEMPORA_GRUNT3_DEFEATED
	const EVENT_TEMPORA_GRUNT4_DEFEATED
	const EVENT_TEMPORA_GRUNT5_DEFEATED
	const EVENT_TEMPORA_GRUNT6_DEFEATED
	const EVENT_TEMPORA_GRUNT7_DEFEATED
	const EVENT_TEMPORA_GRUNT8_DEFEATED
	const EVENT_TEMPORA_GRUNT10_DEFEATED
	
	const EVENT_TEMPORA_SWITCH1_ACTIVATED
	const EVENT_TEMPORA_SWITCH2_ACTIVATED
	const EVENT_TEMPORA_SWITCH3_ACTIVATED
	
	const EVENT_TEMPORA_WARP_ACTIVATED
	
	const EVENT_TEMPORA_GRUNT9_MOVED
	
	const EVENT_TEMPORA_DITTO_USED
	
	const EVENT_TEMPORA_MINERVA_DEFEATED
	
	const EVENT_TEMPORA_LEADER_DEFEATED
