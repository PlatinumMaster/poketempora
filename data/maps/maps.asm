...
MapGroup_Dungeons:
	...
	map MahoganyMart1F, TILESET_TRADITIONAL_HOUSE, INDOOR, MAHOGANY_TOWN, MUSIC_CHERRYGROVE_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_NewBark:
	...
	map NewBarkTown, TILESET_UNDERGROUND, TOWN, NEW_BARK_TOWN, MUSIC_TEMPORA_HIDEOUT, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map ElmsLab, TILESET_LAB, INDOOR, NEW_BARK_TOWN, MUSIC_PROF_ELM, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PlayersHouse1F, TILESET_PLAYERS_HOUSE, INDOOR, NEW_BARK_TOWN, MUSIC_TEMPORA_TEAMENC, FALSE, PALETTE_DAY, FISHGROUP_SHORE
